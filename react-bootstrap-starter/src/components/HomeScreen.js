      ...
      <header className="masthead">
        <div className="container">
          <div className="intro-text">
            ...
            <Link to="/signUp">
                <button className="btn btn-primary btn-xl text-uppercase js-scroll-trigger m">Sign-UP</button>
            </Link>
            <Link to="/signIn">
                <button className="btn btn-primary btn-xl text-uppercase js-scroll-trigger m">Sign-In</button>
            </Link>
          </div>
        </div>
      </header>
